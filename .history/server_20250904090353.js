...
const authRoutes = require("./routes/stockRoute");
...
mongoose.connect(process.env.MONGODB_URL, {  //It means you're accessing a file called ".env" and it has a variable called "MONGODB_"
  //
